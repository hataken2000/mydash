...
- **「まとめて」と言われたタイミングで、Notionまとめと合わせてCLAUDE.mdも更新する**
  - 更新対象: 未着手タスク / 新しい設計判断 / 実装パターンの変化
  - 更新不要: コミット履歴・一時的な作業メモ・すでにコードに反映済みの詳細
- **このファイルが200行を超えてきたらハタケに知らせる**
  - 肥大化した場合は古い設計判断・完了済みタスクを整理する
